...
under a millisecond. It also means a client that damages the table -- and a client
can, because Mosaic legitimately needs to create temporary tables -- has it back
...
stop themselves being turned back on. They do not make the endpoint read-only.
